		...
		<main>
			<div class="mt-2 card">
				...
				<div class="card-body">
					...
					<form id="createForm"  calss="form-iline">
						<div class="form-row align-items-center">
							...
							<!--  여행코스 불러오기 모달창 -->
							<form id="travelCourse">
								<div class="col-sm-4">
									<div class="form-group">
										<button type="button" class="btn btn-primary btn-block"
											data-toggle="modal" data-target="#selectTravelCourseModal">
											여행 코스 선택하기</button>
									</div>
								</div>
						</div>
						<div class="modal fade" id="selectTravelCourseModal" tabindex="-1"
							role="dialog" aria-labelledby="selectTravelCourseModalLabel"
							aria-hidden="true">
				...
				<div class="text-right mt-3">
					...
					<!--  임시저장 불러오기 모달창 -->
					<form id="selectDraftForm" action="post/review/draft">
						...
						<div class="modal fade" id="selectDraftModal" tabindex="-1"
							...
							<div class="modal-dialog modal-lg" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form id="draftForm" action="yourActionURL" method="post">
											<input type="hidden" name="selectedDraft" id="selectedDraft">
										</form>

										<ul class="list-group">
											<c:forEach items="${drafts}" var="draft">
												<li class="list-group-item"><a href="#"
													onclick="selectDraftById('${draft.draftPostId}'); return false;">
														${draft.title} - ${draft.modifiedTime} </a></li>
											</c:forEach>
										</ul>
									</div>
									<div class="modal-footer">
