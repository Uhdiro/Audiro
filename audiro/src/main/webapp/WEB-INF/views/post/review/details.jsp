							...
							<tr>
								<td colspan="2"
									...
									<button class="btn favorite-btn"
										...
										<label class="favorite-btn" for="like-btn-${post.postId}">${countFavorite}</label>
									</button>
									<button class="btn like-btn" data-review-id="${post.postId}">
										<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"
							...
							<tr>
								<td class="profile-container" colspan="2"
									...
									<div style="display: flex; align-items: center;">
										<img src="" alt="프로필 이미지" class="p-profile-image"
											id="p-profile-image" />
										<div>
											<span>${post.nickname}</span> <br /> <label
												for="modifiedTime" class="label-time"
							...
							<tr>
								<td>t
									<div id="content" class="form-control"
										style="white-space: pre-line;">${post.content}</div>
								</td>
							</tr>
						</tbody>
					</table>
									...
									<ul class="list-group list-group-flush">
										<li class="list-group-item">
											<div class="form-inline mb-2">
												<label id="commentId" data-comment-id="${post.commentId}"
													for="replyId"> <i class="fa fa-user-circle-o fa-2x"></i>
												</label>
											</div>

											<div style="display: flex; align-items: flex-start;">
												<!-- 프로필 db내용불러오기로 수정 할 예정 -->
												<img
													...
													alt="프로필 이미지" class="c-profile-image"
											...
											<div class="form-check form-switch ml-auto">
												<input class="form-check-input" type="checkbox"
													role="switch" id="secrectComment"> <label
													class="form-check-label" for="secrectComment">비밀댓글</label>
											</div>
											<div class="d-flex justify-content-end">
												<button id="registerCommmetnbtn" type="button"
													class="btn btn-dark mt-3" onClick="javascript:addReply();">
													댓글등록
											    </button>
											</div>
										</li>
